...
<body>
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6">
                <h1>{{ $filme['titulo'] }}</h1>
                <p class="lead"><strong>Diretor:</strong> {{ $filme['diretor'] }}</p>
                <p class="lead"><strong>Ano de Lançamento:</strong> {{ $filme['ano_lancamento'] }}</p>
                <p>{{ $filme['descricao'] }}</p>
                <a href="{{ asset('trailer.mp4') }}" class="btn btn-secondary" target="_blank">Assistir Trailer</a>
            </div>
            <div class="col-md-6">
                <img src="{{ asset('prim.jpg') }}" class="img-fluid rounded shadow-lg" alt="{{ $filme['titulo'] }}">
            </div>
        </div>
        <hr>
