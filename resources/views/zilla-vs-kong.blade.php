...
<head>
    ...
    <title>Detalhes do Filme - Zilla vs Kong</title>
...
<body>
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6">
                <h1>Título do Filme: Godzilla Vs Kong</h1>
                <p class="lead"><strong>Diretor:</strong> Adam Wingard</p>
                <p class="lead"><strong>Ano de Lançamento:</strong> 2021</p>
                <p>Descrição: Eu torço para Godzilla</p>
                <a href="{{ asset('trailer.mp4') }}" class="btn btn-secondary" target="_blank">Assistir Trailer</a>
            </div>
            <div class="col-md-6">
                <img src="{{ asset('primeiro.png') }}" class="img-fluid rounded shadow-lg" alt="Máquinas Mortais">
            </div>
        </div>
        <hr>
